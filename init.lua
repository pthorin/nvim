...
-- Open file on the line from the previous session
...
vim.keymap.set('n', '<leader>P', '"+P', { desc = '[P]aste from clipboard' })
vim.keymap.set('v', '<leader>y', '"+y', { desc = 'Visual [Y]ank to clipboard' })
vim.keymap.set('v', '<leader>p', '"+p', { desc = 'Visual [P]aste from clipboard' })
vim.keymap.set('v', '<leader>P', '"+P', { desc = 'Visual [P]aste from clipboard' })
